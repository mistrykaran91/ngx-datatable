...
test.describe('single row selection', () => {
  ...
  test(example, async ({ si, page }) => {
    ...
    await si.runVisualAndA11yTests('single-row-selection');
  });
});
...
test.describe('multi row selection', () => {
  ...
  test(example + ' using Shift', async ({ si, page }) => {
    ...
    await si.runVisualAndA11yTests('multi-row-selection-using-shift');
  });
  ...
  test(example + ' using Ctrl', async ({ si, page }) => {
    ...
    await si.runVisualAndA11yTests('multi-row-selection-using-ctrl');
  });
});
...
test.describe('multi click with checkbox selection', () => {
  ...
  test(example + ' using keyboard', async ({ si, page }) => {
    ...
    await si.runVisualAndA11yTests('multi-click-with-checkbox-selection', [
      {
        id: 'label',
        enabled: false
      },
    ...
    await si.runVisualAndA11yTests('multi-click-with-checkbox-selection-backward-navigation', [
      {
        id: 'label',
        enabled: false
      },
