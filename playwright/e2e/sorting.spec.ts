...
test.describe('sorting', () => {
  test.describe('client-side-sorting', () => {
    ...
    test(example, async ({ si, page }) => {
      ...
      await si.runVisualAndA11yTests('client-side-sorting');
      ...
      await si.runVisualAndA11yTests('client-side-sorting-asc');
      ...
      await si.runVisualAndA11yTests('client-side-sorting-desc');
      ...
      await si.runVisualAndA11yTests('client-side-sorting-unset');
    });
  });
  ...
  test.describe('server-side-sorting', () => {
    ...
    test(example, async ({ si, page }) => {
      ...
      await si.runVisualAndA11yTests('server-side-sorting-asc');
      ...
      await si.runVisualAndA11yTests('server-side-sorting-desc');
      ...
      await si.runVisualAndA11yTests('server-side-sorting-asc-again', [
        {
